            ...
            <div className="w-11/12 mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <div className="dropdown">
                        ...
                        <ul
                            tabIndex={0}
                            className="menu menu-sm dropdown-content bg-base-100 rounded-box shadow mt-3 w-40 p-2 z-50"
                        >
                            <li><NavLink to="/" end>Home</NavLink></li>
                            <li><NavLink to="/services">Service List</NavLink></li>
                            {user && (
                                <>
                                    <li><NavLink to="/add-service">Add Services</NavLink></li>
                ...
                <div className="flex items-center gap-3">
                    ...
                    {user ? (
                        <div className="dropdown dropdown-end">
                            ...
                            <ul
                                tabIndex={0}
                                className="menu menu-sm dropdown-content bg-base-100 rounded-box shadow mt-3 w-48 p-2 z-50"
                            >
