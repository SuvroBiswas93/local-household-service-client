...
const Footer = () => {
  ...
  return (
    <div className="dark:bg-black text-gray-900 dark:text-white mt-20">
      <div className="w-11/12 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <MotionLink
              to="/"
              className="flex items-center text-xl font-bold bg-gradient-to-r from-blue-900 to-teal-500 bg-clip-text text-transparent"
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex gap-4 mb-4 md:mb-0">
            <MotionLink
              ...
              target="_blank"
              className="w-10 h-10 bg-gradient-to-r from-blue-900 to-teal-500 rounded-full flex items-center justify-center text-white"
